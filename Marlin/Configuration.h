 ...
 *
 * This version configured for Buster CoreXY Large Format printer
 *
 */
#pragma once
...
#define CUSTOM_MACHINE_NAME "BUSTER"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Buster
  #define DEFAULT_Kp 39.97
  #define DEFAULT_Ki 3.42
  #define DEFAULT_Kd 116.72

  // Ultimaker
  //#define DEFAULT_Kp 30.24
  //#define DEFAULT_Ki 2.70
  //#define DEFAULT_Kd 86.67
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 600, 600, 30, 10000 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { -19, 0, -2.90 }

// Most probes should stay away from the edges of the bed, but
// with NOZZLE_AS_PROBE this can be negative for a wider probing area.
#define MIN_PROBE_EDGE 00
